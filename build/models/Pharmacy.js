...
var pharmacySchema = new _mongoose.Schema({
  razonSocial: {
    type: String,
    required: true
  },
...
pharmacySchema.statics.encryptPassword = /*#__PURE__*/function () {
...
pharmacySchema.statics.comparePassword = /*#__PURE__*/function () {
...
var _default = (0, _mongoose.model)('Pharmacy', pharmacySchema);
